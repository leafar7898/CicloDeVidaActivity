...
package desmob.ftce.usjt.br.ciclodevidaactivity.util;
...
public class Utils {
    ...
    private static desmob.ftce.usjt.br.ciclodevidaactivity.util.StatusTracker mStatusTracker = desmob.ftce.usjt.br.ciclodevidaactivity.util.StatusTracker.getInstance();
